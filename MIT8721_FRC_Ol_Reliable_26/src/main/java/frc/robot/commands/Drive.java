...
public class Drive extends Command {
  ...
  @Override
  public void execute() {
    double throttle = -controller.getLeftY() * DRIVE_SCALING;
    double turn = -(controller.getRightX() + controller.getRightY()) * ROTATION_SCALING;
    driveSubsystem.driveArcade(throttle, turn);
  }
